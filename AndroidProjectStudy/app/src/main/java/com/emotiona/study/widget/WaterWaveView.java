...
public class WaterWaveView extends View {
	...
	private int mRingSTROKEWidth = 10;
	...
	private String flowNum = "新手专享";
	private String flowLeft = "10.0%";
...
//				mScreenWidth * 5 / 8, mScreenHeight * 5 / 8, linePaint);
		float num = leftPaint.measureText(flowLeft);
		canvas.drawText(flowLeft, mScreenWidth * 4 / 8 - num / 2,
				mScreenHeight * 4 / 8, leftPaint);
		float left = flowPaint.measureText(flowNum);
		canvas.drawText(flowNum, mScreenWidth * 4 / 8 - left / 2,
				mScreenHeight * 3 / 8, flowPaint);
