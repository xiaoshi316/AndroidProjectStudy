...
public class SurfView2 extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public SurfView2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SurfView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void Draw() {
        ...
        canvas.drawArc(rectF, 30.0f, 120f, false, paint);
